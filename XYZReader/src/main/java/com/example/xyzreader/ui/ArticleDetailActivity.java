...
public class ArticleDetailActivity extends AppCompatActivity
    ...
    private final SharedElementCallback mSharedElementCallback = new SharedElementCallback() {
        ...
        public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
            if (mIsReturning) {
                ImageView sharedElement = mArticleDetailFragment.getArticlePhotoView();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentPosition = (savedInstanceState == null) ? mStartPosition
                : savedInstanceState.getInt(STATE_CURRENT_POSITION);
